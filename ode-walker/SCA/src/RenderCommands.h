...
{
	rcCapsule=0,rcSphere,rcBox,rcLine,rcMaterial,rcColor,rcViewPoint,rcPrint,rctScreenShot,rctLightPosition,rctMarkerCircle,rcUnityBody,rcUnityForce
};
...
void rcDrawCapsule (const float pos[3], const float R[12], float length, float radius, bool writeLog=false);
